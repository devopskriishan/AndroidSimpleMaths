package com.skpd.androidsimplemaths;
...
import com.skpd.androidsimplemaths.util.CommonUtil;
import com.skpd.androidsimplemaths.util.MathFunctions;
...
public class DivisionActivity extends AppCompatActivity implements MathBase{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mathsops);
        setTitle("Division");
        ...
        txt_welcome_msg.setText(getString(R.string.add_welcome_msg_1) +
                BLANK_SPACE +
                getIntent().getStringExtra(MainActivity.USER_NAME) +
                BLANK_SPACE +
                getString(R.string.add_welcome_msg_2));
    ...
    public void checkAnswer(View view) {
        ...
        if (correctAnswer==userAnswer) {
            txtVResultMsg.setText(R.string.Correct_Answer);
            txtVResultMsg.setTextColor(ContextCompat.getColor(this,R.color.colorGreenForAlert));
        } else {
            txtVResultMsg.setText(R.string.Incorrect_answer);
